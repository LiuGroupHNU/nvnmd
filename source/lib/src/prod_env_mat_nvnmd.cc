...
#pragma omp parallel for 
  for (int ii = 0; ii < nloc; ++ii) {
    ...
    env_mat_a_nvnmd_cpu (d_em_a, d_em_a_deriv, d_rij_a, d_coord3, d_type, ii, fmt_nlist_a, sec, rcut_smth, rcut, precs, mparams);
...
#pragma omp parallel for 
  for (int ii = 0; ii < nloc; ++ii) {
    ...
    std::vector<FPTYPE> d_em_r_deriv;
    std::vector<FPTYPE> d_rij_a;
    env_mat_a_nvnmd_quantize_cpu (d_em_a, d_em_a_deriv, d_rij_a, d_coord3, d_type, ii, fmt_nlist_a, sec, rcut_smth, rcut, precs, mparams);
