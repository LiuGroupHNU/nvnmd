...
def main () :    
    ...
    parser_cal = subparsers.add_parser('cal', help='use model to calculate atomic properties')
    parser_cal.add_argument("-g", "--graph", type=str, 
                            help="The path of frozen graph file")
    parser_cal.add_argument("-a", "--atoms", type=str, 
                            help="The path of atoms file")
