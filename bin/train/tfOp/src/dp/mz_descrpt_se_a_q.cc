...
class MzDescrptSeAqOp : public OpKernel {
public:
  explicit MzDescrptSeAqOp(OpKernelConstruction* context) : OpKernel(context) {
...
#pragma omp parallel for 
	...
	compute_descriptor_se_a_q (d_descrpt_a,
				 d_descrpt_a_deriv,
				 d_rij_a,
				 d_coord3,
				 ntypes, 
...
REGISTER_KERNEL_BUILDER(Name("MzDescrptSeAq").Device(DEVICE_CPU), MzDescrptSeAqOp);
