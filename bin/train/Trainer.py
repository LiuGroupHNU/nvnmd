...
from RunOptions import global_ener_float_precision
from Fitting import EnerFitting, WFCFitting, PolarFittingLocFrame, PolarFittingSeA, GlobalPolarFittingSeA, DipoleFittingSeA
...
from Model import Model, WFCModel, DipoleModel, PolarModel, GlobalPolarModel
from Loss import EnerStdLoss, EnerDipoleLoss, TensorLoss
from LearningRate import LearningRateExp

from tensorflow.python.client import timeline
from env import op_module, op_grads_module
from _tf_op_grad import _prod_force_se_a_grad_cc, _prod_virial_se_a_grad_cc


# from env import get_device_mem
...
class NNPTrainer (object):
    ...
    #     bfb = mem[1] / mem[0]
    #     if bfb > 0.9:
    #         self._message("INFO: stop for memory")
    #         self._message("all: %.2f G, used: %.2f G" % (mem[0], mem[1]))
    #         return -1
    #     else:
    #         return 0
